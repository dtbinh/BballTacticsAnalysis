...
if isempty(train_bags)
    ...
    while 1
        ...
        [all_label_predict, all_prob_predict] = LibSVMMEX([para new_para], sample_instance, sample_label, [train_instance; test_instance], ones(num_train_inst+num_test_inst, 1));
